Vaibz Personal Portfolio Websites
...
- **Social Media Links**: Include links to your GitHub and LinkedIn profiles.
...
4. Customize content:
  ...
  Update social media links like github and linkedin in the (`src>data.ts>BtnList`) .
